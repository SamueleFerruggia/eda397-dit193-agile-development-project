              ...
              builder: (context, _) {
                ...
                return FutureBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, userSnapshot) {
                    ...
                    sentTime =
                        'Sent: ${date.year}-${date.month.toString().padLeft(2, '0')}-${date.day.toString().padLeft(2, '0')} ${date.hour.toString().padLeft(2, '0')}:${date.minute.toString().padLeft(2, '0')}';
                    return Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Amount: ${req.amount.toStringAsFixed(2)} $currency',
                            ),
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    await _firestoreService.addNotification(
                                      ...
                                      message:
                                          'Your settlement request for ${req.amount.toStringAsFixed(2)} $currency was accepted.',
                                ...
                                OutlinedButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    await _firestoreService.addNotification(
                                      userId: req.fromUserId,
                                      message:
                                          'Your settlement request for ${req.amount.toStringAsFixed(2)} $currency was declined.',
                                      type: NotificationType.settlement,
                                    );
                                    if (!mounted) return;
                                    innerSetState(() => dismissed = true);
                                    ScaffoldMessenger.of(
                                      ...
                                      const SnackBar(
                                        content: Text('Settlement declined.'),
                                      ),
                                    );
                                  },
      ...
      builder: (context, snapshot) {
        ...
        return FutureBuilder<List<GroupMember>>(
          ...
          builder: (context, memberSnapshot) {
            ...
            final allSettled = members.every(
              (m) => (balances[m.uid] ?? 0).abs() < 0.01,
            );
              ...
              child: Column(
                ...
                children: [
                  ...
                  StreamBuilder<List<SettleRequest>>(
                    stream: _firestoreService.streamSettleRequestsForGroup(
                      widget.groupId,
                    ),
                    builder: (context, reqSnapshot) {
                      ...
                      return Column(
                        children: requests
                            .map((req) => settleRequestCard(req, currency))
                            .toList(),
                      );
                    },
                  ),
