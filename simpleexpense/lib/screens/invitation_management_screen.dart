...
class _InvitationManagementScreenState
  ...
  Future<void> _removeMember(String memberId, String memberName) async {
    ...
    try {
      final groupsProvider = context.read<GroupsProvider>();
      final currentGroupId = groupsProvider.currentGroupId;
  ...
  Widget build(BuildContext context) {
    return Consumer2<GroupsProvider, AuthProvider>(
      builder: (context, groupsProvider, authProvider, child) {
        ...
        final isAdmin = groupsProvider.selectedGroup?.adminId == currentUserId;
        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              ...
              // Action Button - Only show for admins
              if (isAdmin) ...[
                Padding(
              ...
              Expanded(
                child: FutureBuilder<List<GroupMember>>(
                  future: _firestoreService.getGroupMembers(
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _buildMemberCard(
                          ...
                          isAdmin: isAdmin,
                          onRemove: () => _removeMember(member.uid, member.name),
                        );
                      },
                    );
                  },
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            // Remove button - only show for admins, and not for the current user or other admins
            if (isAdmin && !isCurrentUser && !isMemberAdmin)
              IconButton(
                icon: const Icon(
                  Icons.remove_circle,
                  color: Colors.red,
            ...
            else if (!isAdmin || isCurrentUser || isMemberAdmin)
              Icon(
                Icons.check_circle,
                color: Colors.green,
                size: 20,
